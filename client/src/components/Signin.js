      ...
      <div className="bg-primary-grey-500 border-2 border-primary-grey-500 p-8 rounded-lg w-full max-w-sm">
        ...
        <form>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center border rounded-lg border-1 border-zinc-500 bg-primary-grey-500 shadow appearance-none w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
          ...
          <div className="mb-4 text-right">
            <a href="#" className="text-primary-red-500 hover:text-primary-red-700 text-sm font-medium">
              Forgot password?
            </a>
          </div>
          ...
          <div className="text-sm mt-8 text-center text-white">
            ...
            <a href="#" className="text-primary-red-500 hover:text-primary-red-700 ml-2 font-medium">Create one</a>
          </div>
        </form>
      </div>
    </div>
